...
public class CategoryServicesImpl implements ICategoryService {
    ...
    public ResponseEntity<CategoryResponseRest> search() {
        ...
        try {
            ...
            response.setMetada("Respuesta no.ok", "-1", "Error al consultar");
            e.getStackTrace();
    ...
    public ResponseEntity<CategoryResponseRest> searchById(Long id) {
        ...
        try {
            ...
            response.setMetada("Respuesta no.ok", "-1", "Error al consultar por id");
            e.getStackTrace();
            return new ResponseEntity<CategoryResponseRest>(response, HttpStatus.INTERNAL_SERVER_ERROR);
    ...
    @Override
    @Transactional
    public ResponseEntity<CategoryResponseRest> deleteById(Category category, Long id) {
        ...
        try {
           ...
           response.setMetada("respuesta ok", "00", "Registro eliminado");
            ...
            response.setMetada("Respuesta no.ok", "-1", "Error al eliminar");
            e.getStackTrace();
            return new ResponseEntity<CategoryResponseRest>(response, HttpStatus.INTERNAL_SERVER_ERROR);
